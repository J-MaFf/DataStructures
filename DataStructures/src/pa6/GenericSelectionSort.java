...
public class GenericSelectionSort<T> { // A generic class for selection sorting comparable objects
    ...
    private static void stringSort() {
        ...
        for (String str : arr) strings.add(str);
        GenericSelectionSort<String> stringSelectionSort =
            new GenericSelectionSort<>(new StringComparator());
    ...
    private static void studentSort() throws FileNotFoundException {
        ...
        System.out.print("Original Order: ");
        for (Student student : students) System.out.print(
            student.toString() + " "
        );

        // Create selection sort instance for sorting Students using the StudentComparator
        GenericSelectionSort<Student> studentSelectionSort =
            new GenericSelectionSort<>(new StudentComparator());
