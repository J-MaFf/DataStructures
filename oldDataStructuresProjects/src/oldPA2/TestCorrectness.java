...
public class TestCorrectness {
	...
	public static void testBinarySearchMethods() {
		...
		System.out.println("Array is " + Arrays.toString(C_1) + ". Max is at index " + BinarySearchApplications.findPeak(C_1, C_1.length));
		int C_2[] = { 31, 35, 23, 14, 9, 1, -1 };
		System.out.println("Array is " + Arrays.toString(C_2) + ". Max is at index " + BinarySearchApplications.findPeak(C_2, C_2.length));
		int C_3[] = { 31, 35, 37, 39 };
		System.out.println("Array is " + Arrays.toString(C_3) + ". Max is at index " + BinarySearchApplications.findPeak(C_3, C_3.length));
		int C_4[] = { 36, 35, 32, 29 };
		System.out.println("Array is " + Arrays.toString(C_4) + ". Max is at index " + BinarySearchApplications.findPeak(C_4, C_4.length));
	}
